...
public class SUDOKU_GAME extends javax.swing.JFrame {
    ...
    private Stack<JButton> stBtn = new Stack<>();
    private Stack<String> stDigit = new Stack<>();
    //private HashSet<JButton> preDefine = new HashSet<>(Arrays.asList(arr));
     ...
     */
    private void undo(){
       JButton btn = stBtn.pop();
       String st = stDigit.pop();
       btn.setText(st);
    }
    ...
    private void solutionBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_solutionBtnActionPerformed
        ...
        if (globalFlag != true && (JOptionPane.showConfirmDialog(this, "By Showing Solution Game will Reset!!", "SUDOKU", JOptionPane.YES_NO_OPTION)) == JOptionPane.YES_OPTION)
            showSolution();
